import{i as u,a as _,e as g,l as D,_ as T}from"./index-D1euVNta.js";const h=2,d=.5;function O(r){const{context:e,particle:t,radius:i,opacity:n}=r,a=t.shapeData;if(!a)return;const l=a.value;if(l===void 0)return;t.text===void 0&&(t.text=u(l,t.randomIndexData));const o=t.text,c=a.style??"",x=a.weight??"400",m=Math.round(i)*h,y=a.font??"Verdana",w=t.shapeFill,f=o==null?void 0:o.split(`
